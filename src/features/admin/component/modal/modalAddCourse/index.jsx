...
const ModalAddCourse = ({ isOpen, onRequestClose, onSubmitHandler }) => {
  ...
  const onSubmitHandlerd = async (data) => {
    ...
    try {
      ...
      dispatch(fetchCourses()); // Gọi action fetchUsers để cập nhật danh sách người dùng
  ...
  return (
    ...
    >
      <ModalTitle>Thêm mới khóa học</ModalTitle>
